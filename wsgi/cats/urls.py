...
from kittens.routers import router
from kittens.views import UserRetrieveAPIView, UserCreateAPIView
...
urlpatterns = [
    ...
    path('api/v1/user/<int:pk>/', UserRetrieveAPIView.as_view()),
    path('api/v1/user/register/', UserCreateAPIView.as_view()),
