...
from .serializers import MessageSerializer, RoomSerializer, UserRetrieveSerializer
...
class RoomConsumer(ObserverModelInstanceMixin, GenericAsyncAPIConsumer):
    ...
    def current_users(self, room: Room):
        return [UserRetrieveSerializer(room.first_user).data,
                UserRetrieveSerializer(room.second_user).data]
